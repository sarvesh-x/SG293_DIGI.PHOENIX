...
.im:hover {
  ...
  transform: scale(1.5); 
                ...
                <div class="row">
                    <div class="col-sm-12">
					<button class="btn"style="float:left;margin-right:9px;"><i class = "material-icons large">arrow_back</i></button>
					<h4 style="color:black;float:left;"><b style="color:gray;"><?php echo $t_name; ?> </b>Status <p><?php echo date('d-m-y', strtotime($date)); ?></p></h4>
